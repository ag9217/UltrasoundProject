...
%
%     kgrid*                 - k-space grid structure returned by kWaveGrid
...
% kspaceFirstOrder3D, kWaveGrid, movie2avi, smooth, unmaskSensorData
...
if use_kspace
    kappa = ifftshift(sinc(c_ref .* kgrid.dt .* kgrid.k / 2));
else
    kappa = 1;
end
