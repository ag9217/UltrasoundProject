...
Cone(cone_gridPoints_Z+1:128,:,:) = 0;  % Nx = 128 when cone was "designed", now independent of kgrid size
...
x_pos = x - radius;    % [m]
y_pos = 20.5e-3;      % [m]
scattering_region2 = makeBall(Nx_tot, Ny_tot, Nz_tot, round(x_pos/dx), 80, Nz_tot/2, round(radius/dx));
